  ...
  <div class="wrap">
    <div class="cols">
      <div>
        ...
        <p style="margin-top:16px; max-width:32ch">Pure joy of dance, confidence for life — training dancers since 1994.</p>
        <p style="margin-top:12px; font-size:.9rem"><a href="https://www.instagram.com/pacificdance/" style="color:var(--sky)">Instagram</a> · <a href="https://www.facebook.com/PacificDanceIrvine/" style="color:var(--sky)">Facebook</a></p>
      </div>
      <div>
        <h4>Visit</h4>
        <ul>
  ...
  <div class="wrap twocol form-first">
    <div>
      ...
      <div style="margin-top:24px; display:flex; flex-direction:column; gap:18px">
        ...
        <div class="card-p"><h3>3 · Come dance — free</h3><p style="margin-top:6px">Before the first class, a parent signs a quick liability waiver — a standard insurance requirement that takes a minute. Then your dancer takes the floor. Love it? <a href="how-to-enroll.html" style="color:var(--royal); font-weight:600">Complete your registration →</a></p></div>
      </div>
    </div>
    <div>
      <div class="formcard" id="bookform">
        ...
        <form onsubmit="event.preventDefault(); window.location.href='thank-you.html';">
          ...
          <label>How did you hear about us? *</label><select required><option></option><option>Google</option><option>Instagram / Facebook</option><option>TikTok</option><option>A friend or family</option><option>Drove by the studio</option><option>Other</option></select>
  ...
  <div class="wrap">
    ...
    <div class="twocol">
      ...
      <div class="card-p">
        ...
        <p style="margin-top:16px; font-size:.85rem; color:var(--slate)">Tuition runs on Auto Pay (charged around the 1st). <b>*</b> Class cards expire 60 days from purchase. To change or drop classes, email us by the 20th of the month for the following month. Performing Group &amp; competition details are shared after enrollment, at the start of the performing group season.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="block">
  <div class="wrap" style="max-width:820px">
    ...
    <details class="acc" open><summary>How big are the classes?</summary><div class="inner"><p>Capped small on purpose — with appropriate class sizes for every age and level — so every dancer gets individual corrections and is known by name.</p></div></details>
    ...
    <details class="acc"><summary>Can I watch my dancer's class?</summary><div class="inner"><p>Yes — every studio has viewing windows, plus a comfortable parent waiting area where siblings do homework between classes.</p></div></details>
...
<section class="block">
  <div class="wrap twocol">
    ...
    <div>
      ...
      <div class="card-p" style="margin-top:16px">
        <h3>Share your photos &amp; videos</h3>
        <p style="margin-top:10px; font-size:.92rem">Got a great shot from class or recital? Add it to our shared album — we love featuring our dancers on social.</p>
        <div style="display:flex; gap:16px; align-items:center; margin-top:14px; flex-wrap:wrap">
          <img src="../assets/img/media-submission-qr.png" alt="QR code to submit photos and videos to Pacific Dance" style="width:100px; height:100px; border-radius:8px; flex-shrink:0">
          <div>
            <a class="btn btn-primary" href="https://photos.app.goo.gl/46DDxuC3UoNjMnVG9" target="_blank" rel="noopener" style="padding:.58rem 1.25rem; font-size:.9rem">Add your photos &amp; videos →</a>
            <p style="margin-top:8px; font-size:.82rem; color:var(--slate)">Or scan the code from your phone.</p>
          </div>
        </div>
        <p style="margin-top:16px; font-size:.9rem">Follow along: <a href="https://www.instagram.com/pacificdance/" style="color:var(--royal); font-weight:600">Instagram</a> · <a href="https://www.facebook.com/PacificDanceIrvine/" style="color:var(--royal); font-weight:600">Facebook</a> · <a href="https://www.tiktok.com/@pacific_dance" style="color:var(--royal); font-weight:600">TikTok</a> · <a href="https://www.youtube.com/@pacificdance6398" style="color:var(--royal); font-weight:600">YouTube</a></p>
        <p style="margin-top:8px; font-size:.85rem; color:var(--slate)">Media inquiries: <a href="mailto:PacificDance1@gmail.com" style="color:var(--royal); font-weight:600">PacificDance1@gmail.com</a></p>
      </div>
...
<section class="block" style="padding-top:56px">
  <div class="wrap twocol">
    ...
    <div>
      <div class="card-p"><h3>Small classes, always</h3><p style="margin-top:6px">Appropriate class sizes for every age and level — every kid is seen, corrected, and known by name.</p></div>
      ...
      <div class="card-p" style="margin-top:14px"><h3>Watch every minute</h3><p style="margin-top:6px">Every studio has viewing windows, plus a comfortable parent waiting area — homework happens between classes.</p></div>
...
<section class="block">
  <div class="wrap" style="max-width:760px">
    ...
    <div class="steps3">
      <div class="step"><span class="stepn">1</span><h4>Start with a free class</h4><p>New here? Start with a free class so your dancer finds the right fit — no card, no commitment.</p><a href="enroll.html" class="steplink">Book a free class →</a></div>
